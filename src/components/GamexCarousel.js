...
import game from "../img/GamexBg.jpg"
...
export default class GamexCarousel extends Component {
    render() {
        ...
        const CustomButtonGroup = ({ next, previous, goToSlide, carouselState}) => {
            ...
            if(window.innerWidth <= 576){
              ...
              return (
                ...
                <button className="thumb_slider" onClick={() => previous()} >{React.Children.toArray(thumbnail)[index]}</button>
        ...
        return (
          <div className="container_event" style={{backgroundImage:`url(${game})`}}>
